...
placerBonus([]).
placerBonus([Actuel|Suivants]):-!,
	placerBonus(Suivants).

	
	
initialise(DimX,DimY,VieJoueurs,DegatsBase,DefenseBase,Portee,ListeBonus,NombreObstacles,keep):-
	repeat,
	createGame(DimX,DimY,VieJoueurs,DegatsBase,DefenseBase,Portee,ListeBonus,NombreObstacles),!.
	
initialise(DimX,DimY,VieJoueurs,DegatsBase,DefenseBase,Portee,ListeBonus,NombreObstacles,_):-
	repeat,
	createGame(DimX,DimY,VieJoueurs,DegatsBase,DefenseBase,Portee,ListeBonus,NombreObstacles),!,
	cleanVisites.
