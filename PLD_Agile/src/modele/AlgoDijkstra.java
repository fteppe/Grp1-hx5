...
public class AlgoDijkstra {
	...
	public void chargerAlgo(HashMap<Integer, Intersection> intersections,
			HashMap<Integer, List<Troncon>> troncons) {
		sommets.clear();
		int position = 0;
		// On initialise l'ensemble des sommets a parcourir par
		// l'algorithme,
	 ...
	 * @return Deux tableaux contenant l'ensemble des couts et des
	 *         itineraires optimaux resultant des calculs de plus court
	 *         chemin effectues
	 */
	public Object[] calculerDijkstra(ArrayList<Integer> idSommets) {
		...
		int position = 0;
		// On calcule les plus courts chemins en utilisant l'algorithme
		// de
		...
		for (Integer i : idSommets) {
			...
			// On complete les tableaux de cout et d'itineraires
			// permettant de
	 ...
	 * @param idSommets
	 *                Identifiants des intersections vers lesquelles il faut
	 *                trouver les plus courts chemins
	 * @return Deux tableaux contenant l'ensemble des couts et des
	 *         itineraires optimaux resultant des calculs de plus court
	 *         chemin partant d'un unique sommet
	 */
	public Object[] calculerDijkstra(int sourceId, ArrayList<Integer> idSommets) {
		// On réinitialise les etats, antecedents et couts des sommets
		// pour
		// recalculer
		...
		// On initialise la liste des sommets gris en y mettant le
		// sommet source
		...
		while (!sommetsGris.isEmpty()) {
			...
			if (this.troncons.get(premierSommet.getId()) != null) {
				for (Troncon t : this.troncons.get(premierSommet.getId())) {
					...
					if (etat != Etat.NOIR) {
						// On enleve du tas binaire le
						// sommet pret a etre
						// relache
						// avant sa modification afin de
						// ne pas dissocier
						// l'objet recupere
						// et celui contenu dans la
						// liste des sommets gris
		...
		// On transforme la liste des sommets avec leur antecedent en un
		// tableau
		// d'itineraires
	...
	/**
	 * Mise en place de la liste des itineraires correspondant aux plus
	 * courts chemins calcules selon l'algorithme de Dijkstra a partir d'un
	 * unique sommet defini
	 * 
	 * @param idSommets
	 *                Identifiants des intersections constituant la tournee
	 *                finale
	 * @param listeSommets
	 *                Liste des sommets parcourus par l'algorithme de
	 *                Dijkstra
	 * @param sourceId
	 *                Identifiant du sommet de depart
	 * @return Tableau d'itineraires correpondant aux plus courts chemins
	 *         entre le sommet de depart et les sommets constituant la
	 *         tournee finale
	 */
	private Itineraire[] convertirTableauItineraires(ArrayList<Integer> idSommets,
		...
		// calcules a partir d'un unique sommet de depart, et possedant
		// pour
		...
		for (Integer id : idSommets) {
			...
			// Si il n'y a pas de chemin entre le sommet de depart
			// et le sommet
			// courant,
	...
	/**
	 * Enumeration servant au calcul de plus court chemin selon l'algorithme
	 * de Dijkstra
	 * 
	 * @author utilisateur
	 *
	...
	private class Sommet implements Comparable<Sommet> {
		 ...
		 *                Id du sommet
		 * @param position
		 *                Position dans les tableaux de cout et
		 *                d'itineraires servant au calcul de la tournee
		 *                finale
		 * @param cout
